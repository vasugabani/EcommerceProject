...
export default function AppButton({titel,onPress}) {
  return (
    <View>
      <TouchableOpacity style={{width:'90%',height:verticalScale(45),backgroundColor:'#DB3022',borderRadius:moderateScale(40),padding:11,marginLeft:horizontalScale(20),shadowOpacity: 0.10,shadowRadius: 30,elevation: 4,}} 
      onPress={onPress}>
