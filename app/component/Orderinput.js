...
export default function Orderinput({ordernumber,date,TNumber,Quantity,Amount,status,onPress}) {
  return (
    <View>
     <View style={{width:'95%',height:verticalScale(170),padding:15,marginTop:verticalScale(20),backgroundColor:'white',marginLeft:horizontalScale(10),borderRadius:moderateScale(10),shadowOpacity: 1,shadowRadius:20,elevation:4,}}>
        ...
        <View style={{flexDirection:'row',marginTop:verticalScale(8)}}>
            ...
            <Text style={{fontSize:moderateScale(18),marginTop:verticalScale(5),marginLeft:horizontalScale(80)}}>Total Amount:<Text  style={{fontSize:moderateScale(18),color:'black',}}>{Amount}</Text></Text>
        </View>
        <View style={{flexDirection:'row'}}>
        <TouchableOpacity onPress={onPress} style={{width:horizontalScale(100),height:verticalScale(45),borderWidth:1,borderRadius:25,shadowOpacity: 0.25,shadowRadius: 30, elevation:4,backgroundColor:'white',padding:10,marginTop:5}}>
